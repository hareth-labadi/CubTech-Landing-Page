    ...
    <section className="flex px-4 justify-center xs:flex-col xs:gap-24 lg:flex-row bg-silver pb-20 mb-10">
      <div className="max-w-[850px] relative">
        <h1 className="text-secondary mb-4 mt-12">
          ...
          <span className="text-primary" style={{ display: 'inline-block' }}><AnimatedLogo /></span>
        </h1>
        ...
        <button className="py-3 lg:py-4 px-12 lg:px-16 text-primary cursor-not-allowed font-semibold rounded-lg bg-secondary hover:bg-secondary-hover transition-all outline-none">Join Us</button>
      </div>

      <div className="relative">
        <Image src={"/hero.png"} alt="hero" width={355} height={340} />
