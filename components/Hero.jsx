    ...
    <section className="flex px-4 justify-center xs:flex-col xs:gap-24 lg:flex-row bg-silver pb-20 mb-10">
      <div className="max-w-[850px] relative">
        ...
        <p className="text-gray-700 mb-10">
          Cub Tech is a scientific club located within the men&#39;s residence
          of CUB1 at Bab Ezzouar. Our mission revolves around fostering a
          collaborative environment where knowledge sharing thrives. Through
          lectures, workshops, and collaborative projects, we aim to deepen
          understanding across various scientific disciplines, inspiring
          lifelong learning and a sense of camaraderie among our members.
        </p>

        {/* Fix button hover effect (assuming missing hover styles) */}
        <button className="py-4 lg:py-4 px-12 lg:px-16 text-primary cursor-not-allowed font-semibold rounded-lg bg-secondary hover:bg-secondary-hover transition-all outline-none">
          Join Us
        </button>
      </div>
