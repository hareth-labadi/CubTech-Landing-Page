  ...
  return (
    <section className="flex px-4 justify-center xs:flex-col xs:gap-24 lg:flex-row bg-silver pb-20 mb-10">
      ...
      <span className="text-primary" style={{ display: 'inline-block' }}><AnimatedLogo /></span>
        ...
        <button className="py-3 lg:py-4 px-12 lg:px-16 text-primary cursor-not-allowed font-semibold rounded-lg bg-secondary hover:shadow-blue-md transition-all outline-none">Join Us</button>
      </div>
