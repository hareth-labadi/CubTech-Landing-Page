...
const Talks = () => {
  return (
    <section id="talks" className="mx-auto text-center mb-10">
      ...
      <p className="mb-6 text-gray-700">Explore Our Latest Talks</p>
      <div className="grid grid-cols-3 text-gray-700 xs:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 px-8 justify-items-center">
